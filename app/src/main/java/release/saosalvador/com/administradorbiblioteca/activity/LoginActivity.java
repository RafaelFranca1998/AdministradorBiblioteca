...
//                .set(map);
    ...
    private void attemptLogin() {
        ...
        String email = MyCustomUtil.codeBase64(mEmailView.getText().toString());
        String password = MyCustomUtil.codeBase64(mPasswordView.getText().toString());
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            firebaseFirestore
                    .collection("c2VuaGFz")
                    .document("s9XUN6kgjHTTG9OrQ62w")
                    .collection("YWRtaW5pc3RyYWRvcg")
                    .document("q8vzhV6D8Z8TOr2abXmV")
                    .get()
