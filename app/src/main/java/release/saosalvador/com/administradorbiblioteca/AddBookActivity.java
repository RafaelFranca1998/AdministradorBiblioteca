...
import release.saosalvador.com.administradorbiblioteca.config.RandomKey;
...
public class AddBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextLivroNome = findViewById(R.id.edit_text_livro_nome);
        editTextLivroAutor = findViewById(R.id.edit_text_livro_autor);
        editTextLivroCategoria = findViewById(R.id.edit_text_livro_categoria);
        editTextLivroEditora = findViewById(R.id.edit_text_livro_editora);
        editTextLivroAno = findViewById(R.id.edit_text_livro_ano);
        ...
        btAbrirLivro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //              TODO importante view para abrir Abre o view de leitura pdf
...
//                String caminho = data.getData().getPath(); // usar @caminhoDoArquivo
    ...
    private void adiconarLivro(){
        try {
            ...
            saveLivro(this, livro, caminhoDoArquivo);
    ...
    /**TODO importante
     * Metodo para salvar e enviar o livro deverá passar o objeto livro e o caminho do arquivo.
     */
    public void saveLivro(Context context, Livro livro, String caminho){
        try {
            ...
            nomelivro = nomelivro.replaceAll("\\s","_");
            nomelivro = nomelivro.replace(".pdf","");
            storageReference = DAO.getFirebaseStorage()
                    .child(livro.getArea())
                    .child(livro.getCategoria())
                    .child(livro.getIdLivro())
                    .child(nomelivro);
